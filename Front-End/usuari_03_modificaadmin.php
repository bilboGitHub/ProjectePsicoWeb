...
<body>
    ...
    <h1>BORRAR / MODIFICAR usuari administrador</h1>
...
<form action="usuari_03_modificaadmin.php" method="post">
    usuari:
    <select name="slusuari" style="width: 300px;">
        <option value="" ></option>  
...
?>
        <br><br>
        <table border='2'>
            <tr><td>ID: </td><td><input type="text" name="tbID" size="100%" value="<?php echo $usuari->getid_usuari() ?>"></td></tr>
            ...
            <tr><td>tipus: </td><td><input type="text" name="tbtipus" size="100" value="<?php echo $usuari->gettipus_usuari() ?>"></td></tr>                  
        </table>
...
<?php 
    ...
    if (isset($_POST['btModificar']) or isset($_POST['btBorrar'])) {
        ...
        $objusuari2 = new business_usuari ($_POST['tbID'], $_POST['tbemail'], $_POST['tbcontrasenya'], $_POST['tbtipus'] );
