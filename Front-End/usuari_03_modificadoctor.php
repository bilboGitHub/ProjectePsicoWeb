...
<body>
    ...
    <h1>BORRAR / MODIFICAR usuari doctor</h1>
...
<form action="usuari_03_modificadoctor.php" method="post">
    usuari:
...
<?php 
    ...
    if (isset($_POST['btModificar']) or isset($_POST['btBorrar'])) {
        ...
        $objusuari2 = new business_usuari (null, $_POST['tbemail'], $_POST['tbcontrasenya'], 1 );
