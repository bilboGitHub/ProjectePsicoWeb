...
<form action="usuari_02.php" method="post">
    <table border=2>
        ...
        <tr><td>tipus: </td><td><input type="text" name="tipus" size="100%"></td></tr>
    </table>
    <br>
...
if (isset($_POST['btInsertar'])) {
   $error="";         
   $objusuari = new business_usuari(null, $_POST['email'], $_POST['contrasenya'], $_POST['tipus']);
